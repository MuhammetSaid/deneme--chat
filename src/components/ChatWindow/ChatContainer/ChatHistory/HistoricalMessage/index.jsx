      ...
      <div className="py-[5px]">
        {role === "assistant" && (
          <div className={`allm-text-[10px] allm-text-gray-400 allm-ml-[54px] allm-mr-6 allm-mb-2 allm-text-left allm-font-sans`}>
            {embedderSettings.settings.assistantName || "Aiksir Yazılım"}
          </div>
        )}
        <div key={uuid} ref={ref} className={`allm-flex allm-items-start allm-w-full allm-h-fit ${ role === "user" ? "allm-justify-end" : "allm-justify-start"}`}>
          {role === "assistant" && (
            <img
              src={embedderSettings.settings.assistantIcon || "https://media.licdn.com/dms/image/v2/D4D0BAQH3PtnotRnAcQ/company-logo_200_200/company-logo_200_200/0/1713812133762/aiksir_logo?e=1737590400&v=beta&t=a4VSAmyLV58Dn1mSF8rgH_9EMWvMmtfDLmsHFbHFkr8"}
