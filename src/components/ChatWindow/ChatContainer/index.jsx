...
export default function ChatContainer({
  ...
  return (
    <div className="allm-h-full allm-w-full allm-flex allm-flex-col"  style={{height:"auto", minHeight:"80vh"}}>
      
      <div className="allm-flex-grow allm-overflow-y-auto">
        <ChatHistory settings={settings} history={chatHistory} />
      </div>
      
      <PromptInput message={message} submit={handleSubmit} onChange={handleMessageChange} inputDisabled={loadingResponse} buttonDisabled={loadingResponse} settings = {settings} />
