...
export default function ChatWindowHeader({
  ...
  return (
    ...
    >
      <div className="allm-flex allm-items-center allm-w-full allm-h-[76px]">
        <div className="header-image" style={{ backgroundColor:"white", marginLeft:"30px" , padding:"7px 8px" , borderRadius:"50%" , overflow:"hidden"}}>
          <img 
            style={{ maxWidth: 44, maxHeight: 44 }}
            src={settings.assistantIcon}
